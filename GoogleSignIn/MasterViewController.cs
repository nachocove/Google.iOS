...
{
    public partial class MasterViewController : UITableViewController, IGIDSignInDelegate, IGIDSignInUIDelegate
    {
        ...
        public override void ViewDidLoad ()
        {
            ...
            TableView.TableHeaderView = new GIDSignInButton ();
            ...
            GIDSignIn.SharedInstance.UIDelegate = this;
        }
...
//                TableView.InsertRows (new [] { indexPath }, UITableViewRowAnimation.Automatic);
        ...
        {
            Console.WriteLine ("MasterViewController:DidSignInForUser: {0} {1}", signIn, user);
            AppDelegate.Dumper (user);
        }
